...
import material.repository.PonudjaciRepository;
...
/**
 * REST controller for managing {@link material.domain.Ponudjaci}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class PonudjaciResource {
    ...
    public ResponseEntity<Ponudjaci> updatePonudjaci(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ponudjaci.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Ponudjaci> partialUpdatePonudjaci(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ponudjaci.getId().toString())
        );
    }
