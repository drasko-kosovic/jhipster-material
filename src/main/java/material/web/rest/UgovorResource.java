...
import material.repository.UgovorRepository;
...
/**
 * REST controller for managing {@link material.domain.Ugovor}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class UgovorResource {
    ...
    public ResponseEntity<Ugovor> updateUgovor(@PathVariable(value = "id", required = false) final Long id, @RequestBody Ugovor ugovor)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ugovor.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Ugovor> partialUpdateUgovor(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, ugovor.getId().toString())
        );
    }
